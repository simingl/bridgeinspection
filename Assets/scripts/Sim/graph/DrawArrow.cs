...
public static class DrawArrow
{
	...
	public static void ForDebug(Vector3 pos, Vector3 direction, float arrowHeadLength = 8f, float arrowHeadAngle = 20.0f)
	{
	...
	public static void ForDebug(Vector3 pos, Vector3 direction, Color color, float arrowHeadLength = 8f, float arrowHeadAngle = 20.0f)
	{
